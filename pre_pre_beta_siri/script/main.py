"""
Entry point для застосунку. Головний цикл обробки ітерацій між користувачем знаходится тут. 
Також містить словник доступних дій і відповідну функцію виклику
"""
import sys
